                        ...
                        <div class="offcanvas-body accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <a class="accordion-button collapsed" href="home-buyer.html" aria-label="Vai alla home">Home</a>
                                </h2>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <a class="accordion-button collapsed" href="#" aria-label="Vai alla pagina supporto/aiuto">
                                        Aiuto
