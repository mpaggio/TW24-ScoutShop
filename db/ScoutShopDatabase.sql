...
create table ORDINE (
     ...
     LettoCompratoreYN char not null default '0',
     LettoVenditoreYN char not null default '0',
     EliminatoCompratoreYN char not null default '0',
     EliminatoVenditoreYN char not null default '0',
